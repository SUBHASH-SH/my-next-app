      ...
      <div className="container mx-auto px-4 py-8" style={{ maxWidth: '800px', color: 'black' }}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            ...
            <div className="space-y-6 mt-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-base font-semibold text-gray-800 mb-4">How to Download</h2>
                <div className="text-gray-600 whitespace-pre-line text-sm">{resut.how_to_download}</div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-1">
            {/* Latest Results */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-base font-semibold text-gray-800 mb-4">Check More Admit Cards</h2>
              <div className="space-y-3">
                {/* Placeholder for Latest Jobs */}
                {results.map(result => (
                  <div key={result.title} className="border-b pb-3 last:border-0">
                    <Link href={`/admit-card/${result.id}`} className="block hover:text-red-700">
